...
model_save_path = os.path.join('',arch,model_save_path)
...
if not os.path.isdir(os.path.dirname(os.path.dirname(os.path.dirname(model_save_path)))):
    os.mkdir(os.path.dirname(os.path.dirname(os.path.dirname(model_save_path))))
if not os.path.isdir(os.path.dirname(os.path.dirname(model_save_path))):
    os.mkdir(os.path.dirname(os.path.dirname(model_save_path)))
if not os.path.isdir(os.path.dirname(model_save_path)):
    os.mkdir(os.path.dirname(model_save_path))
if not os.path.isdir(model_save_path):
    os.mkdir(model_save_path)
assert os.path.isdir(model_save_path), 'Error: no save directory! %s'%(model_save_path)
...
feature_dim = input_data_length
input_data_length = [feature_dim,feature_dim]

"""Load Network"""
net = []

net.append(feature_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_concat(input_data_length=input_data_length, class_num=class_num))
net.append(feature_concat(input_data_length=input_data_length, class_num=class_num))

net.append(feature_CCM(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_BN(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_BN(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_ReLU(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_ReLU(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_BN_ReLU(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_BN_ReLU(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_weighted_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_weighted_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_BN_weighted_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_BN_weighted_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_Sigmoidweighted_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_Sigmoidweighted_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_BN_Sigmoidweighted_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_BN_Sigmoidweighted_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_ReLU_weighted_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_ReLU_weighted_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_BN_ReLU_weighted_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_BN_ReLU_weighted_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_ReLU_Sigmoidweighted_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_ReLU_Sigmoidweighted_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_BN_ReLU_Sigmoidweighted_sum(input_data_length=input_data_length, class_num=class_num))
net.append(feature_CCM_BN_ReLU_Sigmoidweighted_sum(input_data_length=input_data_length, class_num=class_num))
...
training_setting_file.write('model 00: sum_SGD\n')
training_setting_file.write('model 01: sum_Adam\n')
training_setting_file.write('model 02: concat_SGD\n')
training_setting_file.write('model 03: concat_Adam\n')
